...
\setlength{\titleboxwidth}{0.7\textwidth}			% Change box width
\title{Your Title}
\newcommand{\myemail}{Your Email}
\newcommand{\supervisors}{Your Supervisors}
\newcommand{\projecttype}{Your Project Type} % E.g. Semester Project, Bachelor's Thesis, Master's Thesis
\newcommand{\program}{Your Program} % E.g. MSc MATH, MSc RSC
